---
title: "SARGE_Data_Updater: Current Data FL Tampa Jan. 2026"
...
cat("FLORIDA TAMPA SARGE DEPLOYMENT: January 24th to 25th, 2026")

```
![](SARGE_FL_Tampa_Creek.jpg)
...
## Plot 
waterlev <- ggplot(exo, aes(x=TIMESTAMP, y=Depth_m)) + geom_point(color="blue") + ylim(-0.5,2.5) + xlim(c(as.POSIXct('2026-01-24 14:00:00', format = "%Y-%m-%d %H:%M:%S"),
     as.POSIXct('2026-01-25 22:00:00', format = "%Y-%m-%d %H:%M:%S"))) + 
   theme_classic() + labs(title="EXO Water Level")
waterlev

## Plot conductivity 
cond <- ggplot(exo, aes(x=TIMESTAMP, y=Salinity_PPT)) + geom_point(color="purple") + 
xlim(c(as.POSIXct('2026-01-24 14:00:00', format = "%Y-%m-%d %H:%M:%S"),
     as.POSIXct('2026-01-25 22:00:00', format = "%Y-%m-%d %H:%M:%S"))) + ylim(20,40) + 
...
xlim(c(as.POSIXct('2026-01-24 14:00:00', format = "%Y-%m-%d %H:%M:%S"),
     as.POSIXct('2026-01-25 22:00:00', format = "%Y-%m-%d %H:%M:%S"))) + theme_classic() + 
      labs(title="Sontek Flow Rate")
#flow

flow1 <- ggplot(sontek, aes(x=TIMESTAMP, y=as.numeric(Index_velocity))) + geom_point(color="black") +       
xlim(c(as.POSIXct('2026-01-24 14:00:00', format = "%Y-%m-%d %H:%M:%S"),
     as.POSIXct('2026-01-25 22:00:00', format = "%Y-%m-%d %H:%M:%S"))) + ylim(-0.4, 0.3) + 
...
xlim(c(as.POSIXct('2026-01-24 14:00:00', format = "%Y-%m-%d %H:%M:%S"),
     as.POSIXct('2026-01-25 22:00:00', format = "%Y-%m-%d %H:%M:%S"))) + theme_classic() + ylim(0.1,1.5) + 
...
xlim(c(as.POSIXct('2026-01-24 14:00:00', format = "%Y-%m-%d %H:%M:%S"),
     as.POSIXct('2026-01-25 22:00:00', format = "%Y-%m-%d %H:%M:%S"))) + ylim(0,5000)+
