...
waterlev <- ggplot(exo, aes(x=TIMESTAMP, y=Depth_m)) + geom_point(color="blue") + ylim(-0.5,2.5) + xlim(c(as.POSIXct('2026-01-17 12:00:00', format = "%Y-%m-%d %H:%M:%S"),
     as.POSIXct('2026-01-18 12:00:00', format = "%Y-%m-%d %H:%M:%S"))) + 
...
xlim(c(as.POSIXct('2026-01-17 12:00:00', format = "%Y-%m-%d %H:%M:%S"),
     as.POSIXct('2026-01-18 12:00:00', format = "%Y-%m-%d %H:%M:%S"))) + ylim(20,50) + 
...
xlim(c(as.POSIXct('2026-01-17 12:00:00', format = "%Y-%m-%d %H:%M:%S"),
     as.POSIXct('2026-01-18 12:00:00', format = "%Y-%m-%d %H:%M:%S"))) + theme_classic() + 
...
CH4_lgr <- ggplot(flux, aes(x=TIMESTAMP1, y=CH4d_ppmA)) + geom_point(color="red")+
  xlim(c(as.POSIXct('2026-01-17 16:00:00', format = "%Y-%m-%d %H:%M:%S"),
     as.POSIXct('2026-01-18 12:00:00', format = "%Y-%m-%d %H:%M:%S"))) + ylim(0,20000)+
  theme_classic() + labs(title="LI-7810 Equilibrator CO2")
CH4_lgr
...
xlim(c(as.POSIXct('2026-01-17 16:00:00', format = "%Y-%m-%d %H:%M:%S"),
     as.POSIXct('2026-01-18 12:00:00', format = "%Y-%m-%d %H:%M:%S"))) +
  ylim(0, 750) + theme_classic() + labs(title="LI-7810 Equilibrator CH4")
CO2_lgr
...
All_Data <- ggplot() + 
    geom_line(data=flux, aes(x=TIMESTAMP1, y=CO2d_ppmA*1, color="CO2"), size=0.75) + 
    geom_line(data=flux, aes(x=TIMESTAMP1, y=CH4d_ppmA/10, color="CH4"), size=0.75) + 
    ...
    sec.axis = sec_axis(~ . *10, name = "CH4 (ppb)")) + 
     xlim(c(as.POSIXct('2026-01-17 18:00:00', format = "%Y-%m-%d %H:%M:%S"),
     as.POSIXct('2026-01-18 09:00:00', format = "%Y-%m-%d %H:%M:%S"))) +
    theme_classic() + 
    labs(color=NULL)
All_Data
