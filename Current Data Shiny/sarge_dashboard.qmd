...
ghg_names <- read_delim("https://www.dropbox.com/scl/fi/gtmjx6216pfqnmb5cd1yc/WILSON_FLUX_7810.dat?rlkey=zfeh41fxjeyd3jn9sqf76zfza&st=6ljj68yu&dl=1", 
                        delim = ",", skip = 1, show_col_types = F, n_max = 1)
...
output$today <- renderText({
  paste("Current time: ", format(now(tzone = TIMEZONE), "%Y-%m-%d %H:%M:%S"), TIMEZONE)
})
