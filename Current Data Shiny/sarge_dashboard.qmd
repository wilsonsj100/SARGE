...
exo_names <- read_delim("https://www.dropbox.com/scl/fi/0l884zjlaphi2nu9uupiw/WILSON_ExoTable.dat?rlkey=3ydvfbetag118ql5a03f3o9l8&st=80wnki57&dl=1", 
...
hydrology_names <- read_delim("https://www.dropbox.com/scl/fi/dqas4e92ngcsigqy7u107/WILSON_SontekTable.dat?rlkey=iw6azl1fqyyl521jpcgfjjcrk&st=d4xp83p3&dl=1", 
                        delim = ",", skip = 1, show_col_types = F, n_max = 1)
...
ghg_names <- read_delim("https://www.dropbox.com/scl/fi/5mbm233tpfzjzwuxwqqfq/WILSON_FLUX_7810.dat?rlkey=7283hbfameqbscbdvriyx8sml&st=4jl7y7z6&dl=1", 
                        delim = ",", skip = 1, show_col_types = F, n_max = 1)

#Load data
ghg <- read_delim("https://www.dropbox.com/scl/fi/5mbm233tpfzjzwuxwqqfq/WILSON_FLUX_7810.dat?rlkey=7283hbfameqbscbdvriyx8sml&st=4jl7y7z6&dl=1", 
                        delim = ",", skip = 4, show_col_types = F,
...
radon_names <- read_delim("https://www.dropbox.com/scl/fi/ttjde8cpqf7xgn8dgcdv2/WILSON_Rad7Table.dat?rlkey=hcg2ycle3cmkerc6ic7pa13g1&st=vx91f41x&dl=1", 
                        delim = ",", skip = 1, show_col_types = F, n_max = 1)
